...
public class ClassAnalyzer
{
    ...
    {
        IEnumerable<string> methodparams = _type.GetMethods().Where(m => m.Name == methodname).SelectMany(m => m.GetParameters()).Select(mp => mp.Name ?? string.Empty).Append(methodname);
        return methodparams;
    }
